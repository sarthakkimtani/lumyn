...
const ThemedEnrichedMarkdownText = withUnistyles(EnrichedMarkdownText, (theme, rt) => ({
  markdownStyle: {
    ...
    code: {
      color: rt.themeName === "dark" ? "#6FC2FF" : "#0A5FA5",
      backgroundColor: rt.themeName === "dark" ? "#1B1B1B" : "#F2F4F7",
      borderColor: rt.themeName === "dark" ? "#2C2C2C" : "#E4E6EA",
    },
    codeBlock: {
      fontSize: 14,
      fontFamily: "Menlo",
    ...
    blockquote: {
      ...
      borderWidth: 3,
      gapWidth: 10,
      backgroundColor: rt.themeName === "dark" ? "#0C1924" : "#EAF5FE",
      marginBottom: 12,
      color: theme.colors.text,
      lineHeight: 24,
    },
    ...
    thematicBreak: {
      color: rt.themeName === "dark" ? "#2A2A2A" : "#E6E6E6",
      height: 1,
      marginTop: 8,
      marginBottom: 12,
    },
